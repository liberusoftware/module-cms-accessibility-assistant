# Cms: Accessibility Assistant Core Module

> This package is the authoritative, provider-neutral implementation of Accessibility Assistant. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-accessibility-assistant?sort=semver)](https://github.com/liberusoftware/module-cms-accessibility-assistant/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-accessibility-assistant/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-accessibility-assistant/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-accessibility-assistant
```
...
<a href="https://github.com/liberusoftware/module-cms-accessibility-assistant/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-accessibility-assistant" alt="Contributors to liberusoftware/module-cms-accessibility-assistant">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-accessibility-assistant/graphs/contributors).
